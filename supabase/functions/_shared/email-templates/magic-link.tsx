...
export const MagicLinkEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your login link for Korex Intelligence Systems</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Click the button below to log in to Korex Intelligence Systems. This link will expire shortly.
        </Text>
